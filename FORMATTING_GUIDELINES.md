...
To ensure consistent code formatting and linting across the project, this document outlines the configured tools
and their usage.
...
- The above configuration ensures all files are formatted with a consistent 120-character column width,
  2-space indentation, and Unix-style line endings.
